...
**Alpha v0.4.9 — Real-Time Coaching**
...
- Local JSON savegame with non-destructive v0.4.5 → v0.4.9 migration for MMR, real-time fatigue, coaching, titles, development stats and stream revenue
